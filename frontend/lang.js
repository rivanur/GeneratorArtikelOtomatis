const translations = {
    'id': {
        ...
        'footer_desc': 'Menulis lebih cerdas, berkreasi lebih cepat, dan meraih lebih banyak dengan LetterWrap - Teman menulis terbaik Anda.',
        ...
        'footer_rights': '&copy; 2026 LetterWrap. All Rights Reserved',
        ...
        // Index - Features
        'feat_title': 'Kenapa Memilih LetterWrap?',
        ...
        'contact_info': 'Atau email kami langsung di: support@letterwrap.com',

        // Help Page
        'help_title': 'Pusat Bantuan',
        'help_desc': 'Temukan jawaban untuk pertanyaan yang paling sering diajukan mengenai LetterWrap.',
        'faq_1_q': 'Apa itu LetterWrap?',
        'faq_1_a': 'LetterWrap adalah platform asisten penulisan berbasis AI yang dirancang untuk membantu pembuat konten, blogger, dan pemasar membuat artikel SEO yang dioptimalkan dalam hitungan detik dari berbagai sumber seperti teks manual, URL web, video YouTube, atau dokumen.',
        ...
        'faq_3_q': 'Apakah LetterWrap gratis digunakan?',
        'faq_3_a': 'LetterWrap versi dasar sepenuhnya gratis untuk dicoba. Anda dapat menggunakan API Key Anda sendiri (bring-your-own-key) seperti Groq atau Gemini untuk menikmati generasi tanpa batas dengan biaya sendiri (atau gratis jika menggunakan kuota gratis mereka).',
        ...
        'auth_subtitle_login': 'Silakan masuk ke akun LetterWrap Anda.',
        ...
        'privacy_intro_desc': 'Di LetterWrap, kami memahami bahwa informasi pribadi Anda sangat penting. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi Anda saat menggunakan situs web kami.',
        ...
        'terms_intro_desc': 'Selamat datang di LetterWrap. Syarat dan Ketentuan ini ("Perjanjian") mengatur akses dan penggunaan Anda terhadap layanan, situs web, produk, dan aplikasi yang disediakan oleh LetterWrap. Dengan mengakses atau menggunakan layanan kami, Anda setuju untuk terikat dengan ketentuan ini.',
        'terms_h2': '2. Lisensi Penggunaan',
        'terms_p2': 'LetterWrap memberikan Anda lisensi terbatas, non-eksklusif, dan tidak dapat dialihkan untuk menggunakan perangkat lunak kami untuk tujuan pribadi dan komersial (yaitu menghasilkan artikel).',
    ...
    'en': {
        ...
        'btn_login': 'Login',
        'btn_dashboard': 'Dashboard',
        'footer_desc': 'Write smarter, create faster, and achieve more with LetterWrap - Your ultimate writing companion.',
        ...
        // Index - Features
        'feat_title': 'Why Choose LetterWrap?',
        ...
        'contact_info': 'Or email us directly at: support@letterwrap.com',

        // Help Page
        'help_title': 'Help Center',
        'help_desc': 'Find answers to the most frequently asked questions about LetterWrap.',
        'faq_1_q': 'What is LetterWrap?',
        'faq_1_a': 'LetterWrap is an AI-powered writing assistant platform designed to help content creators, bloggers, and marketers create SEO-optimized articles in seconds from various sources like manual text, web URLs, YouTube videos, or documents.',
        ...
        'faq_3_q': 'Is LetterWrap free to use?',
        'faq_3_a': 'The basic version of LetterWrap is completely free to try. You can use your own API Keys (bring-your-own-key) like Groq or Gemini to enjoy unlimited generations at your own cost (or for free if using their free tier).',
        ...
        'auth_subtitle_login': 'Please log in to your LetterWrap account.',
        ...
        'privacy_intro_desc': 'At LetterWrap, we understand that your personal information is very important. This Privacy Policy explains how we collect, use, and protect your information when using our website.',
        ...
        'terms_intro_desc': 'Welcome to LetterWrap. These Terms of Service ("Agreement") govern your access to and use of the services, websites, products, and applications provided by LetterWrap. By accessing or using our services, you agree to be bound by these terms.',
        'terms_h2': '2. Usage License',
        'terms_p2': 'LetterWrap grants you a limited, non-exclusive, and non-transferable license to use our software for personal and commercial purposes (i.e., generating articles).',
